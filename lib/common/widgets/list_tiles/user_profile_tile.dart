...
class TUserProfileTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      title: Text('Coding with Tobi', style: Theme.of(context).textTheme.headlineSmall!.apply(color:TColors.white)),
      subtitle: Text('support@example.com', style: Theme.of(context).textTheme.bodyMedium!.apply(color:TColors.white),),
